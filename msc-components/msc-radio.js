module.exports = function ({ addComponents, theme }) {
  const radio = {
    ".msc-radio-container": {
      "@apply flex w-fit py-2 px-3 bg-white items-center shadow-md list-none":
        {},
    },
    ".msc-radio-input": {
    ...
    ".msc-radio-horizontal-main-container": {
      "@apply items-center w-[150px] text-sm bg-white border rounded flex list-none pl-0 h-fit":
        {},
    },
    ".msc-radio-horizontal-container": {
      "@apply w-full border-b border-gray-100 border-r rounded-l list-none": {},
    },
    ".msc-input-horizontal-container": {
      "@apply flex items-center ps-3 list-none": {},
    },
