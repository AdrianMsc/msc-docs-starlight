...
<div class="msc-radio-container">
  <input
    ...
    class="msc-radio-input"
  />
  <label for="radio-yes" class="msc-radio-label"> Yes{" "} </label>
</div>
<div class="msc-radio-container">
  <input
    id="radio-no"
    ...
    class="msc-radio-input"
  />
  <label for="radio-no" class="msc-radio-label"> No{" "} </label>
</div>
```
...
<div class="component-container">
  <ul class="msc-radio-horizontal-main-container">
    <li class="msc-radio-horizontal-container">
      <div class="msc-input-horizontal-container !mb-0">
        <input
  ...
  <li class="msc-radio-horizontal-container">
    <div class="msc-input-horizontal-container">
      <input
        ...
        class="msc-input-horizontal"
      />
      <label for="horizontal-list-radio-yes" class="msc-input-horizontal-label">
        Yes
      </label>
    </div>
  </li>
  <li class="msc-radio-horizontal-container">
    <div class="msc-input-horizontal-container">
      <input
        ...
        class="msc-input-horizontal"
      />
      <label for="horizontal-list-radio-no" class="msc-input-horizontal-label">
        No
      </label>
    </div>
  </li>
